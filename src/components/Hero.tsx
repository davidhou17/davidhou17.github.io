    ...
    <section className="min-h-screen flex items-center justify-center relative">
      <div className="container-width text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-light mb-6 leading-tight">
          Hi, I'm <span className="font-medium">Alex</span>
        </h1>
        ...
        <Button 
          ...
          variant="outline" 
          size="lg"
          className="border-teal text-teal hover:bg-teal hover:text-primary"
        >
          Learn More About Me
        </Button>
      </div>
      ...
      <button 
        onClick={scrollToAbout}
        className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-teal hover:text-teal-dark transition-colors"
